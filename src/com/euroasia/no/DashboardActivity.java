...
public class DashboardActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		share.setOnClickListener(new OnClickListener() {
        	public void onClick(View v) {
				...
				i.putExtra(Intent.EXTRA_TEXT, "Med en kraftig søkefunksjon, tilbyr, "+getString(R.string.app_name)+" deg millioner av høykvalitets sanger. Du kan enten høre dem online eller få gratis nedlastninger. Opplev en auditiv fest akkurat nå! "+getString(R.string.app_name)+" Download Link: https://market.android.com/details?id="+getString(R.string.market_url));
		...
		if(!isInternetConnectionActive(getApplicationContext())) {
			...
			builder.setMessage("Du trenger en aktiv internettforbindelse for å bruke de fleste funksjonene i appen. Vennligst gå inn i dine innstillinger og aktiver WiFi!")
				   .setCancelable(false)
	...
	public void rateapp(){		
		...
		if(hasBeenShown == false){
			String title = "Vurder oss på Android Market";
			
			String message = "Kjære bruker, hvis du liker applikasjonen vår, vennligst gi oss 5 stjerner. Din vedvarende støtte er kilden til vår forbedring.";
