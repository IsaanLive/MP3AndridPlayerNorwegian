...
import com.euroasia.no.R;
import com.euroasia.no.DownloadingActivity;
...
public class DownloadService extends Service {
	...
	public class DownloadFilesTask  extends AsyncTask<String, Void, Void> {
		...
		protected void onCancelled() {
			...
			regularNotif("Nedlastning avbrutt","Avbrutt: "+filename,filename); 
		...
		protected void onPostExecute(Void result) {
			...
			if(fail == 1){
				regularNotif("Nedlastning mislyktes","Mislyktes: "+filename,filename); 
				http--;
				...
				regularNotif("Nedlastning fullf¿rt","Ferdig: "+filename,filename); 
			}
		...
		public void ongoingNotif(String contentTitle, String tickerText, String contentText ){
			...
			notification.setLatestEventInfo(context, contentTitle, "Trykk her for Œ vise fremgang", contentIntent);
			notificationManager.notify(numberd+9, notification);
		}
